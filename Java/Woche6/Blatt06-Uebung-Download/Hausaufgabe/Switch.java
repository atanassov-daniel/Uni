...
public class Switch {
    ...
    private String name;
    /** Getter fuer den Namen des aktuellen Switch-Objekts
    * @return den Namen des aktuellen Switch-Objekts
    */
    public String getName() {
        return name;
    }
    /** Setter fuer den Namen des aktuellen Switch-Objekts
    * @param name gewuenschte Name
    */
    public void setName(String name) {
        this.name = name;
    }

    /** Getter fuer den ersten Nachfolger des aktuellen Switch-Objekts
    * @return den ersten Nachfolger
    */
    public Switch getSucc0() {
        return this.succ0;
    }
    /** Getter fuer den zweiten Nachfolger des aktuellen Switch-Objekts
    * @return den zweiten Nachfolger
    */
    public Switch getSucc1() {
        return this.succ1;
    }
    /** Setter fuer den ersten Nachfolger des aktuellen Switch-Objekts
    * @param succ0 der gewuenschte erste Nachfolger
    */
    public void setSucc0(Switch succ0) {
        this.succ0 = succ0;
    }
    /** Setter fuer den zweiten Nachfolger des aktuellen Switch-Objekts
    * @param succ1 der gewuenschte zweite Nachfolger
    */
    public void setSucc1(Switch succ1) {
        this.succ1 = succ1;
    }
    /** Getter fuer den "dritten" Nachfolger des aktuellen Switch-Objekts
    * @return den "dritten" Nachfolger
    */
    public Switch getVorfolger() {
        return this.vorfolger;
    }
    /** Setter fuer den "dritten" Nachfolger des aktuellen Switch-Objekts
    * @param vorfolger der gewuenschte "dritte" Nachfolger
    */
